...
execute join(['function! vital#_bakaup#Data#Either#import() abort', printf("return map({'flat_map': '', 'bimap': '', 'from_left': '', 'apply': '', 'null_to_left': '', 'left': '', 'right': '', '_vital_depends': '', 'unsafe_from_left': '', 'is_left': '', 'map_left': '', 'map': '', 'bind': '', 'return': '', 'is_right': '', 'is_either': '', 'join': '', 'from_right': '', 'unsafe_from_right': '', '_vital_loaded': ''}, \"vital#_bakaup#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
